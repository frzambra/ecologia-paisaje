---
title: "Ecologia del Paisaje (1/2)"
...
- 24 de Julio: Conceptos de ecología del paísaje
    ...
    3. Ejemplo
    4. Aplicaciones desde la teledeteción
...
3. `Tipo de cobertura:` Categoría dentro de un esquema de clasificación definido por el usuario que distingue entre los diferentes hábitats, ecosistemas, vegetación o tipos de paisaje.
...
## Paisaje {.smaller background-image="img/Cuesta_del_obispo_01.jpg" background-position="50% 100%"}
...
## Heterogeneidad {background-image='img/ejemplo_heterogeneidad.png' background-size="100%"}
...
## Aplicación 2: Tendencia de cambio en bosques {.smaller}
...
![](img/desguldad_RM25 3.png){width="100%" fig-align="center"}